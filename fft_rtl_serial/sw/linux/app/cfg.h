...
#define FFT_BITS 12
/*
 * This SoC instantiates 64 accelerator TLB entries and uses 1 MiB chunks.
 * One FFT frame needs 32 KiB of input plus 32 KiB of output, therefore one
 * DMA mapping can hold 1024 frames. Larger user requests are split into
 * consecutive hardware runs by the application; this is not a CLI limit.
 */
#define FFT_HW_FRAMES_PER_RUN 1024U
